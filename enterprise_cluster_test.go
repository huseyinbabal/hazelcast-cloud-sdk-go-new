...
func ExampleEnterpriseClusterService_delete() {
	client, _, _ := New()
	cluster, _, _ := client.EnterpriseCluster.Delete(context.Background(), &models.ClusterDeleteRequest{ClusterId: "53807"})
	fmt.Printf("Result: #%v ", cluster)
